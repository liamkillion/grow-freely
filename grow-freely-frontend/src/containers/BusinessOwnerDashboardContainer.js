...
class BusinessOwnerDashboardContainer extends React.Component {
  render() {
    return (
      <div className="container">
        <Row>
          <Col s={4} />
          <Col s={4}>
            <h1>Liam Candle Company: Your Profile</h1>
          </Col>
          <Col s={4} />
        </Row>
        <Row>
          ...
          <Col s={6}>
            <div className="outer-graph">
              <div className="inner-graph">43%</div>
            </div>
          </Col>
          <Col s={3} />
        </Row>
...
export default BusinessOwnerDashboardContainer;
